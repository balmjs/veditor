import { fillCharReg } from './dom-utils';
import utils from './utils';
import dtd from './dtd';
import uNode from './u-node';
...
export default function (htmlstr, ignoreBlank) {
  ...
  htmlstr = htmlstr.replace(fillCharReg, '');
  if (!ignoreBlank) {
  ...
  function text(parent, data) {
    if (needChild[parent.tagName]) {
      let tmpNode = uNode.createElement(needChild[parent.tagName]);
